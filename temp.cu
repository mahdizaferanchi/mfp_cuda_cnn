...
// 	// cudaDeviceSynchronize();
// 	// mnist_model.backprop(1);
// 	// mnist_model.weight_update();
// 	// std::cout << mnist_model.layers[3].activations << '\n';
// 	// std::cout << mnist_model.layers[3].errors << '\n';
// 	// std::cout << mnist_model.layers[3].weights << '\n';
...
// 	// std::cout << mnist_model.layers[1].errors << '\n';
// 	// std::cout << mnist_model.layers[1].weights << '\n';
